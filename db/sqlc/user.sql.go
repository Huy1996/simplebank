...
const updateUserV2 = `-- name: UpdateUserV2 :one
UPDATE users
SET
...
func (q *Queries) UpdateUserV2(ctx context.Context, arg UpdateUserV2Params) (User, error) {
	row := q.queryRow(ctx, q.updateUserV2Stmt, updateUserV2,
		arg.HashedPassword,
