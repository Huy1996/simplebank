...
// Source: github.com/Huy1996/simplebank/db/sqlc (interfaces: Store)
...
// UpdateUserV2 mocks base method.
func (m *MockStore) UpdateUserV2(arg0 context.Context, arg1 db.UpdateUserV2Params) (db.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateUserV2", arg0, arg1)
	ret0, _ := ret[0].(db.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateUserV2 indicates an expected call of UpdateUserV2.
func (mr *MockStoreMockRecorder) UpdateUserV2(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserV2", reflect.TypeOf((*MockStore)(nil).UpdateUserV2), arg0, arg1)
}
